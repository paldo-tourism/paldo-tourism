...
public class AlanDto {
    ...
    public String makeDummy() {
        ...
        messageBuilder.append(travelDate)
                ...
                .append("정도를 생각하고 있어")
                .append("적절한 국내 여행지 중 고속터미널이 있는 도시를 하나만 추천해주고 해당 여행지와 가장 가까운 고속 터미널도 이 중에서 찾아줘, 답변형식에 맞춰서 답변해줘 ")
                .append("답변형식은 다음과 같은 조건에 맞춰서 부탁해 추천해준 목적지, 목적지와 가까운 고속 터미널, 해당 목적지를 추천해준 이유를 적는다.");
